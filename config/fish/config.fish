...
abbr --add edit-fish-config 'vim $XDG_CONFIG_HOME/fish/config.fish'
abbr --add finstall 'sudo flatpak install flahub'
abbr --add fupdate 'flatpak update'
abbr --add nvim-install-plug 'neovim -es -u init.vim -i NONE -c "PlugInstall" -c "qa"'
abbr --add ppath 'echo $PATH'
abbr --add rupdate 'rustup update'
abbr --add source-fish 'source $XDG_CONFIG_HOME/fish/config.fish'
